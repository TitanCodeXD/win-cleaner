...
| **2** | **Cache de Aplicativos** | Resíduos pesados do **Discord / Discord PTB**, navegadores (**Google Chrome** e **Opera GX**), **Spotify** _(Data/Storage)_ e do **Node.js** _(npm-cache)_. |
